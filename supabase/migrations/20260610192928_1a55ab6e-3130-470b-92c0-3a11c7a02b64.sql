...
$$;
REVOKE ALL ON FUNCTION public.report_leads_by_account(timestamptz, timestamptz) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.report_leads_by_account(timestamptz, timestamptz) TO authenticated;